...
?>
    <section class="p-3 w-100">
        ...
        <div class="d-inline-flex flex-column align-items-start">
            <form method="GET" action="index.php" class="d-inline">
                <label for="statusTipos" class="form-label text-muted">Filtrar por status:</label>
                <select name="statusTipos" id="statusTipos" class="form-select w-auto" onchange="this.form.submit()">
                    <option value="" disabled selected>Selecciona una opción...</option>
                    <option value="">Todos</option>
                    <option value="1" <?php if(isset($_GET['statusTipos']) && $_GET['statusTipos'] == '1') echo 'selected'; ?>>Activado</option>
                    <option value="0" <?php if(isset($_GET['statusTipos']) && $_GET['statusTipos'] == '0') echo 'selected'; ?>>Desactivado</option>
                </select>
            </form>
        </div>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <?php
                    ...
                    $status = isset($_GET['statusTipos']) ? $_GET['statusTipos'] : '';
